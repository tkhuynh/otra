...
Performance.create(status: "scheduled", requester_id: nil, performance_date: "2016-02-18", location: "San Francisco, CA", band_id: 6, tour_id: 3, host_id: nil, agree: false)
Performance.create(status: "confirmed", requester_id: 6, performance_date: "2016-02-15", location: "San Diego, CA", band_id: 6, tour_id: 3, host_id: 3, agree: true)
Performance.create(status: "pending", requester_id: 6, performance_date: "2016-02-17", location: "San Jose, CA", band_id: 6, tour_id: 3, host_id: nil, agree: false)
Performance.create(status: "confirmed", requester_id: 6, performance_date: "2016-02-19", location: "Sacramento, CA", band_id: 6, tour_id: 3, host_id: 4, agree: true)
Performance.create(status: "pending", requester_id: 6, performance_date: "2016-02-16", location: "Los Angeles, CA", band_id: 6, tour_id: 3, host_id: nil, agree: false)
